...
//  全局 jquery
  new webpack.ProvidePlugin({
    //引入第三方模式
    $: 'vendors/jquery_1_11_1/jquery-1.11.1.min',
    jQuery: 'vendors/jquery_1_11_1/jquery-1.11.1.min',
    'window.jQuery': 'vendors/jquery_1_11_1/jquery-1.11.1.min',
    'window.$': 'vendors/jquery_1_11_1/jquery-1.11.1.min'
    // $: 'jquery',
    // jQuery: 'jquery',
